...
// src/BrowserLogger.ts
var BrowserLogger_exports = {};
__export(BrowserLogger_exports, {
  ...
  ContextKeyBrowser: () => ContextKeyBrowser,
...
module.exports = __toCommonJS(BrowserLogger_exports);
var import_merge2 = __toESM(require("lodash/merge"));
var import_browser_dtector = __toESM(require("browser-dtector"));
...
// src/BrowserLogger.ts
var BrowserContextKey = /* @__PURE__ */ ((BrowserContextKey2) => {
  BrowserContextKey2["CallerContext"] = "callerContext";
  BrowserContextKey2["BrowserContext"] = "browserContext";
  return BrowserContextKey2;
})(BrowserContextKey || {});
var ContextKey2 = { ...BrowserContextKey, ...ContextKey };
var ContextKeyCaller = /* @__PURE__ */ ((ContextKeyCaller2) => {
  ContextKeyCaller2["LoggerName"] = "loggerName";
  return ContextKeyCaller2;
})(ContextKeyCaller || {});
var ContextKeyBrowser = /* @__PURE__ */ ((ContextKeyBrowser2) => {
  ContextKeyBrowser2["Name"] = "name";
  ContextKeyBrowser2["Platform"] = "platform";
  ContextKeyBrowser2["UserAgent"] = "userAgent";
  ContextKeyBrowser2["Version"] = "version";
  ContextKeyBrowser2["ShortVersion"] = "shortVersion";
  ContextKeyBrowser2["IsAndroid"] = "isAndroid";
  ContextKeyBrowser2["IsTablet"] = "isTablet";
  ContextKeyBrowser2["IsMobile"] = "isMobile";
  ContextKeyBrowser2["IsDesktop"] = "isDesktop";
  ContextKeyBrowser2["IsWebkit"] = "isWebkit";
  ContextKeyBrowser2["IsIE"] = "isIE";
  return ContextKeyBrowser2;
})(ContextKeyBrowser || {});
var CONTEXT2 = (0, import_merge2.default)({}, CONTEXT);
var CONFIG_MINIMAL2 = (0, import_merge2.default)(
  {
    [ContextKey2.BrowserContext]: true
  },
  CONFIG_MINIMAL
);
...
var BrowserLogger = class extends Logger {
  _browserName = "BrowserLogger";
  _browserContextConfig;
  _browserConfigSettings = CONFIG_SETTINGS;
  browserDetector;
  get context() {
    return CONTEXT2;
  }
  ...
  constructor(options) {
    super(options);
    if (typeof global.window !== "undefined") {
      this.browserDetector = new import_browser_dtector.default(global.window?.navigator?.userAgent);
    }
  }
  addCallerContext() {
    this.addBaseContext({
  ...
  addBrowserContext() {
    if (this.browserDetector) {
      ...
      this.addBaseContext({
        [ContextKey2.BrowserContext]: {
          ["name" /* Name */]: browserInfo.name,
          ["platform" /* Platform */]: browserInfo.platform,
          ["userAgent" /* UserAgent */]: browserInfo.userAgent,
          ["version" /* Version */]: browserInfo.version || void 0,
          ["shortVersion" /* ShortVersion */]: browserInfo.shortVersion || void 0,
          ["isAndroid" /* IsAndroid */]: browserInfo.isAndroid,
          ["isTablet" /* IsTablet */]: browserInfo.isTablet,
          ["isMobile" /* IsMobile */]: browserInfo.isMobile,
          ["isDesktop" /* IsDesktop */]: browserInfo.isDesktop,
          ["isWebkit" /* IsWebkit */]: browserInfo.isWebkit,
          ["isIE" /* IsIE */]: browserInfo.isIE
        }
      });
    }
  }
  buildLogObject(level, args) {
    return (0, import_merge2.default)((0, import_merge2.default)(super.buildLogObject(level, args), this.addCallerContext()), this.addBrowserContext());
  }
};
